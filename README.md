...
> 입지, 타깃 고객, 운영 조건 등 **비미각적 요소(Non-taste factors)**를 기반으로 제주도 요식업 매출 등급을 예측하고 전략적 인사이트를 도출한 프로젝트입니다.
...
단일 모델의 한계를 극복하고 예측 편향을 최소화하기 위해 **13개 베이스 모델**과 **2단계 계층적 스태킹** 구조를 설계했습니다.
...
### **3. 최종 메타 스태킹 (25%)**
* 위 세 개 모델의 결과를 다시 입력으로 받아 최종 결론을 내리는 **최상위 Meta Model** 운영
...
## 📈 Conclusion
> "제주도 요식업 성공의 핵심은 **누가(장년층 현지인)**, **어디서(업종 맞춤형 좌표)** 이용하는지의 조화에 있습니다."

이 프로젝트는 데이터 기반의 상권 분석이 실제 비즈니스 의사결정에 어떻게 기여할 수 있는지를 모델 성능과 XAI를 통해 증명했습니다.
